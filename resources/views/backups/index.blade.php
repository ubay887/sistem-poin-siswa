        ...
        <div class="card">
            ...
            <table class="table table-sm table-responsive-sm">
                <thead>
                    ...
                    <th class="text-center">{{ __('backup.file_size') }}</th>
                    <th class="text-center">{{ __('backup.created_at') }}</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ format_size_units($backup->getSize()) }}</td>
                        <td class="text-center">{{ date('Y-m-d H:i:s', $backup->getMTime()) }}</td>
